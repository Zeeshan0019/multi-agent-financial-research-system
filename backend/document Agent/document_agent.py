...
class DocumentAgent:
    ...
    def _clean_text(text: str) -> str:
        ...
        and repair ligature/symbol mis-mappings from certain PDF fonts so
        indexed chunks (and therefore citations/snippets) read cleanly."""
        text = text.replace("\x0c", " ")
        # Repair common ligature/symbol mis-mappings (e.g. "raΘo" -> "ratio").
        _ligatures = {
