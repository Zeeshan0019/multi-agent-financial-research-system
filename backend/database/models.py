...
class FinancialMetric(Base):
    ...
    # Source provenance for citations. `source_pages` is a JSON string mapping
    # each metric key -> the page number it was extracted from (when known).
    # `source_section` is a human label describing where the figures came from.
    source_pages = Column(String(500))
...
class RedFlag(Base):
    ...
    source_section = Column(String(200))
    source_snippet = Column(String(600))
