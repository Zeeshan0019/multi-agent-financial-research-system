                          ...
                          <div className="flex items-baseline justify-between text-xs">
                            <span className="flex items-center gap-2 font-semibold text-ledger-950">
                              ...
                              {row.calculation_note && (
                                <Citation
                                  index={i + 1}
                                  label={row.is_calculated ? "Calculated value" : row.company}
                                  section={row.calculation_note}
                                />
                              )}
                            </span>
                            <span className="flex items-center gap-1.5">
                              {row.is_calculated && (
                                <span
                                  title={row.formula ? `Formula: ${row.formula}` : "Calculated value"}
                                  className="font-mono text-[0.55rem] font-bold px-1 py-0.5 rounded bg-slate-100 text-slate-400 uppercase tracking-wide"
                                >
                                  calc
                                </span>
                              )}
